...
func TestEmailFromReaderAbleToParse(t *testing.T) {
	raw := []byte(`From: "Keith Packard" <keithp@keithp.com>
...
keith.packard at intel.com`)
	...
	if want, got := "[notmuch] Introducing myself", e.Subject; want != got {
		t.Errorf("Incorrect subject. %#q != %#q", want, got)
	}
}
